...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240212053112_AddNewFieldsDesembolsoTable")]
    partial class AddNewFieldsDesembolsoTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.BitacoraFicha", b =>
                {
                    ...
                    b.Property<string>("AppUserAuthorizedId")
                    ...
                    b.HasIndex("AppUserAuthorizedId");

                    b.HasIndex("AppUserId");

                    b.HasIndex("EntidadId");

                    b.ToTable("BitacoraFichas");
                });
            ...
            modelBuilder.Entity("Core.Entities.Desembolso", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("AprobacionCreditos")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("AprobacionDireccion")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.Property<decimal>("MontoDesembolso")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Core.Entities.DetalleDesembolso", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("CantidadDesembolso")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<int?>("MedioDesembolsoId")
                        .HasColumnType("int");

                    b.Property<string>("NombreEmisionCheque")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.HasIndex("DesembolsoId");

                    b.HasIndex("LoteId");

                    b.HasIndex("MedioDesembolsoId");

                    b.HasIndex("TipoCuentaId");

                    b.ToTable("DetalleDesembolsos");
                });

            modelBuilder.Entity("Core.Entities.DetalleLote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("DetalleDesembolsoId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entities.Empresa", b =>
                {
                    ...
                    b.Property<string>("OrigenOtrosIngresos")
                        .HasMaxLength(200)
            ...
            modelBuilder.Entity("Core.Entities.Entrevista", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entities.MedioDesembolso", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entities.MotivoRechazo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entities.Persona", b =>
                {
                    ...
                    b.Property<DateTime?>("FechaInicioNegocio")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Core.Entities.Prestamo", b =>
                {
                    ...
                    b.Property<int?>("AnalistaPrestamoId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entities.ReferenciaEmpresa", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entities.TipoPrestamo", b =>
                {
                    ...
                    b.Property<decimal>("MontoMaximoAnalista")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("MontoMinimoAnalista")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<bool>("PermisosAnalista")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Core.Entities.Views.ListadoDesembolso", b =>
                {
                    b.Property<string>("AprobacionCreditos")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int>("TiempoSolicitud")
                        .HasColumnType("int");

                    b.ToSqlQuery("Exec sp_ListadoDesembolsos");
                });
            ...
            modelBuilder.Entity("Core.Entities.Views.ListadoEntidades", b =>
                {
                    b.Property<string>("DPI")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Core.Entities.BitacoraFicha", b =>
                {
                    b.HasOne("Core.Entities.Identity.AppUser", "AppUserAuthorized")
                        .WithMany("AppUserAuthorizeds")
                        .HasForeignKey("AppUserAuthorizedId");
                    ...
                    b.Navigation("AppUserAuthorized");
            ...
            modelBuilder.Entity("Core.Entities.DetalleDesembolso", b =>
                {
                    ...
                    b.HasOne("Core.Entities.Desembolso", "Desembolso")
                        .WithMany("DetalleDesembolsos")
                        .HasForeignKey("DesembolsoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("Core.Entities.MedioDesembolso", "MedioDesembolso")
                        .WithMany()
                        .HasForeignKey("MedioDesembolsoId");
            ...
            modelBuilder.Entity("Core.Entities.Prestamo", b =>
                {
                    b.HasOne("Core.Entities.Entidad", "AnalistaPrestamo")
                        .WithMany("AnalistaPrestamos")
                        .HasForeignKey("AnalistaPrestamoId");
                    ...
                    b.HasOne("Core.Entities.MotivoRechazo", "MotivoRechazo")
                        .WithMany()
            ...
            modelBuilder.Entity("Core.Entities.Desembolso", b =>
                {
                    b.Navigation("DetalleDesembolsos");
                });
            ...
            modelBuilder.Entity("Core.Entities.Entidad", b =>
                {
                    b.Navigation("AnalistaPrestamos");
            ...
            modelBuilder.Entity("Core.Entities.Identity.AppUser", b =>
                {
                    b.Navigation("AppUserAuthorizeds");
                });
